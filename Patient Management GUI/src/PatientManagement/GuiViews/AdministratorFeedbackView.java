 ...
 * @author Davio
 */
public class AdministratorFeedbackView extends javax.swing.JFrame 
{

    /**
     * Creates new form DoctorsListView
     */
    public AdministratorFeedbackView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Doctor Feedback");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministratorFeedbackView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministratorFeedbackView().setVisible(true);
            }
        });
    }
