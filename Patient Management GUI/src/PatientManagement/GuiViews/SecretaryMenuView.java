 ...
 * @author Davio
 */
public class SecretaryMenuView extends javax.swing.JFrame {

    /**
     * Creates new form SecretaryMenuView
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecretaryMenuView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SecretaryMenuView().setVisible(true);
            }
        });
    }
